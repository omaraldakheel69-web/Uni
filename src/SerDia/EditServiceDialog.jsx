...
export default function EditServiceDialog({ open, onClose, initial, onSave }) {
  ...
  useEffect(() => {
    if (initial) {
      ...
      setForm({ name: "", description: "", pricePerHour: "", category: "" });
    }
  }, [initial, open]);
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      ...
      <DialogContent sx={{ display: "flex", flexDirection: "column", gap: 2, pt: 1 }}>
        ...
        <TextField label="Price per Hour" name="pricePerHour" type="number" value={form.pricePerHour} onChange={handleChange} fullWidth />
