  ...
  const handleSave = async (payload) => {
    try {
      const formattedPayload = {
        ...
        pricePerHour: Number(payload.pricePerHour), // 🔴 IMPORTANT
      };
      ...
      if (
        ...
        isNaN(formattedPayload.pricePerHour)
      ) {
                ...
                {services.map((s) => (
                  <TableRow key={s.id}>
                    ...
                    <TableCell>
                      <IconButton
                        size="small"
                        onClick={() => setEdit({ open: true, initial: s })}
                      >
                        <EditIcon />
                      </IconButton>
                      <IconButton
